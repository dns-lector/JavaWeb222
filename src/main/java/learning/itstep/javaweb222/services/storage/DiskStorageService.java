...
public class DiskStorageService implements StorageService {
    ...
    public String save(FileItem item) throws IOException {
        ...
        // Д.З. : DiskStorageService
        // При збереженні нового файлу необхідно 
        // перевірити чи випадково файл з таким іменем не існує у сховищі
        // За наявності - перегенерувати ім'я
