...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        // перевірити чи є у запиті заголовок авторизації
        // перевірити схему авторизації, у даному фільтрі тільки Bearer
        // вилучити токен, перевірити підпис
        // розкодувати тіло токена, передати до контексту запиту
