        ...
        restResponse.setMeta(
                ...
                .setLinks( Map.ofEntries(
                    Map.entry("create-feedback", "POST /rate?item-id={id}"),
                        ...
                        // у ПОСТ передається ?item-id={id}, а у ГЕТ /{id}
...
/*
Реалізувати стилізацію блоку формування коментаря та оцінки 
товару користувачем.
* додати лічильник символів, що введено до коментаря,
  за умови, що коментар менший за 10 символів блокувати надсилання.
** ігнорувати у коментарях послідовні пробіли та інші заповнювачі
*/